...
# Inicializar a captura de vídeo da webcam (0 representa a webcam padrão)
...
while True:
    ...
    imagem_destacada = destacar_cor_rgb(frame, (red_min, red_max), (green_min, green_max), (blue_min, blue_max))
